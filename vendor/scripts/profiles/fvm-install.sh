#!/usr/bin/env bash
# =============================================================================
# FVM Installer (Vendored)
# =============================================================================
# SECURITY WARNING:
#   This script is vendored locally, but it downloads FVM binaries from GitHub
#   at runtime. The download includes checksum verification via GitHub releases.
#
#   Network access required: github.com, api.github.com
#
#   For maximum security in air-gapped environments:
#   1. Pre-download FVM binary from https://github.com/leoafarias/fvm/releases
#   2. Verify the checksum manually
#   3. Place in FVM_INSTALL_DIR and skip this installer
#
